...
#define WINDOW_TITLE	"Engine3D"
#define WINDOW_WIDTH	640
#define WINDOW_HEIGHT	480
#define FRUSTUM_ZNEAR	1.0f
#define FRUSTUM_ZFAR	300.0f
...
BOOL init(GL_Window* window, Keys* keys);			// Performs All Your Initialization

void dealloc();										// Performs All Your DeInitialization

bool update(DWORD milliseconds);					// Perform Motion Updates

void drawScene();									// Perform All Your Scene Drawing
